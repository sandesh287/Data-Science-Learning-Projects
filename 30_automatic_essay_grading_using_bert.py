...
# Dataset url: https://www.kaggle.com/datasets/kenbwire/automated-essay-scoring

# Note: For this model to train and evaluate, you will need a high-end computer with high gpu and powerful cpu
...
df = pd.read_csv('dataset/30_automatic_essay_grading/essays.csv')
...
for epoch in range(epochs):
  ...
  print(f'Epoch {epoch+1}, Train Loss: {train_loss:.4f}, Val Loss: {val_loss:.4f}, MSE: {mse:.4f}, R2-Score: {r2:.4f}')
